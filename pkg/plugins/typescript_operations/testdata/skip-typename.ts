...
export type GetPostWithFragmentsQuery = { post?: { id: string, title: string, content: string, published: boolean, tags: Array<string>, comments: Array<{ id: string, content: string, author: { id: string, name: string, email: string, role: UserRole, status: Status } }>, author: { id: string, name: string, email: string, role: UserRole, status: Status } } | null };
